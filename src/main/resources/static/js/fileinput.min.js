...
!function (e) {
    ...
    i = {
        ...
        constructor: t, _init: function (t) {
            ...
            var f, m = this, g = m.slug(r), v = "", h = m.previewSettings[t] || m.defaults.previewSettings[t], w = h && h.width ? h.width : "", _ = h && h.height ? h.height : "", b = c || m._renderFileFooter(g, s, i.isEmpty(w) ? "auto" : w, l), C = m._getPreviewIcon(r), y = "type-default", E = C && m.preferIconicPreview, x = C && m.preferIconicZoomPreview, T = function (a, l, s, c) {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(t, function (e, i) {
                ...
                var E, x, T, S, F, I, P, k, z, A, $ = g + e, D = u + "-" + $, U = t[e], j = U.name ? r.slug(U.name) : "", R = (U.size || 0) / 1e3, M = "", L = i.objUrl.createObjectURL(U), Z = 0, O = "";
